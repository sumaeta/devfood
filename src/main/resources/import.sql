...
INSERT into restaurante(nome, taxa_frete, cozinha_id, forma_pagamento_id) values ('Gourmet Thai', 10, 1, 1);
INSERT into restaurante(nome, taxa_frete, cozinha_id, forma_pagamento_id) values ('Thai Komida', 10, 1, 1);
